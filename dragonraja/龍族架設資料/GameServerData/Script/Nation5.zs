...
@Event00002		
	...
	if(yes==1)
	{
		...
		if(yes==1)
		{
			...
			EventMsg("명성(Fame) 50이 내려갑니다.")
			FameDown(50) ; 이동하는 조건으로 Fame x 깎는다.
			QuestTeleport(1,15,115)
		}
		else
		{
			EventMsg("명성(Fame)이 낮아 비밀 지역을 통과할 수 없습니다.")
		}
...
@Event00006		
	...
	{
		EventMsg("명성(Fame)이 낮아 비밀 지역 2층으로 이동할 수 없습니다.")
	}

end
@Event00007
	FameCheck(1150)   ; Fame x 이상이면
	if(yes==1)
	{
		FameDown(100)
	...
	{
		EventMsg("명성(Fame)이 낮아 비밀 지역 3층으로 이동할 수 없습니다.")
	}
