...
if( yes==1 ){
   MessageBox("第三个考核是,必须等级达到110级.名声达到1300.")
   SendSound(0,   64)
...
if( yes==1 ){
   D("任务有6种,可能随机抽中其中的一种,目前边境分的几率为15%.")
...
if( yes==1 ){
   ...
   if(ran==0){
   SendSound(0, 64)
   D("此次的任务是上交'拜索斯机密文件'.")        ;Stay110
   SetQuestNumStep(72,110)
   goto End_QuestNpc00032 
}
   if(ran==1){
   SendSound(0, 64)
   D("此次的任务是上交'杰彭机密文件'.")        ;Stay130
   SetQuestNumStep(72,130)
   goto End_QuestNpc00032 
}
   if(ran==2){
   SendSound(0, 64)
   D("此次的任务是上交'伊斯机密文件'.")        ;Stay150
   SetQuestNumStep(72,150)
   goto End_QuestNpc00032 
}
   if(ran==3){
   SendSound(0,64)
   D("此次的任务是帮助海格莫尼亚的巫女.")    ;Stay0
   SetQuestNumStep(29,0)
   D("她的正确位置是海格莫尼亚[42,530]的井旁边.")        ;Stay106
   ...
   D("此次的任务是帮助海格莫尼亚的巫女.")    ;Stay0
   SetQuestNumStep(29,0)
   D("她的正确位置是海格莫尼亚[42,530]的井旁边.")        ;Stay108
