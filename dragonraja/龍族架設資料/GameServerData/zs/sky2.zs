...
CheckItemMulti(10268,1)
	if(yes>=1)
	{
		BossTimerCheck(86,274,261,7,1800,300,1)	;;20040317 1.4 패치로 인해 77에서 86으로 갱신
			if(yes==0)
				{
...
CheckItemMulti(10264,1)	
	if(yes>=1)
	{
		BossTimerCheck(82,75,88,7,1800,300,1)	;;20040317 1.4 패치로 인해 73에서 82로 갱신
			if(yes==0)
				{
					EventMsg("현재 다른 유저가 전투 중입니다.")	
...
@Event00012	;;퀘스트 1번방 출구
	...
	BossTimerCheck(82,75,88,7,0,0,2)	;;20031030 타임은 0,0 마지막 변수가 2면 모두 초기화
	EventMsg("방에서 나갑니다.")
	ScriptTimer(0,"0",0,0)		
end
...
CheckItemMulti(10265,1)	
	if(yes>=1)
	{
		BossTimerCheck(83,70,470,7,1800,300,1)
			if(yes==0)
				{
					EventMsg("현재 다른 유저가 전투 중입니다.")	
...
@Event00014	;;퀘스트 2번방 출구		
	...
	BossTimerCheck(83,70,470,7,0,0,2)	
	EventMsg("방에서 나갑니다.")
	ScriptTimer(0,"0",0,0)
end
...
CheckItemMulti(10266,1)	
	if(yes>=1)
	{
		BossTimerCheck(84,476,443,7,1800,300,1)
			if(yes==0)
				{
					EventMsg("현재 다른 유저가 전투 중입니다.")	
...
@Event00016	;;퀘스트 3번방 출구		
	...
	BossTimerCheck(84,476,443,7,0,0,2)
	EventMsg("방에서 나갑니다.")
	ScriptTimer(0,"0",0,0)
end
...
CheckItemMulti(10267,1)	
	if(yes>=1)
	{
		BossTimerCheck(85,484,58,7,1800,300,1)
			if(yes==0)
				{
					EventMsg("현재 다른 유저가 전투 중입니다.")	
...
@Event00018	;;퀘스트 4번방 출구
	...
	BossTimerCheck(85,484,58,7,0,0,2)
	EventMsg("방에서 나갑니다.")
	ScriptTimer(0,"0",0,0)
end
@Event00019		
